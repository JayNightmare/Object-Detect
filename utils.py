...
def download_yolo_files():
    ...
    print(
        "1. Download yolov3.weights from: https://pjreddie.com/media/files/yolov3.weights"
    )
    print(
        "2. Download yolov3.cfg from: https://github.com/pjreddie/darknet/blob/master/cfg/yolov3.cfg"
    )
    print(
        "3. Download coco.names from: https://github.com/pjreddie/darknet/blob/master/data/coco.names"
    )
...
def enhance_contrast(
    frame: np.ndarray, alpha: float = 1.2, beta: int = 10
) -> np.ndarray:
    """
...
def draw_crosshair(
    frame: np.ndarray, color: Tuple[int, int, int] = (0, 255, 0), thickness: int = 1
) -> np.ndarray:
    """
    ...
    cv2.line(
        frame, (center_x - 20, center_y), (center_x + 20, center_y), color, thickness
    )
    # Draw vertical line
    cv2.line(
        frame, (center_x, center_y - 20), (center_x, center_y + 20), color, thickness
    )
